...
/**
 * Takes FileList and expands any zip files
 *
 * Given a filelist:
 *
 *   - foo.js
 *   - bar.zip
 *
 * Where `bar.zip` contains three files:
 *
 *   - b.js
 *   - a.js
 *   - r.js
 *
 * This will return a new collection list:
 *
 *  - ./foo.js
 *  - ./bar.zip/b.js
 *  - ./bar.zip/a.js
 *  - ./bar.zip/r.js
 *
 * The returned object uses the path as a key, and the blob as a value.
 *
